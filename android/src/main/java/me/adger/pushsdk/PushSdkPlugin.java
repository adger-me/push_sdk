...
import me.adger.pushsdk.req.SimulateRequest;

/** PushSdkPlugin */
public class PushSdkPlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "push_sdk");
    channel.setMethodCallHandler(this);

    MobpushReceiverPlugin.registerWith(flutterPluginBinding.getBinaryMessenger());
