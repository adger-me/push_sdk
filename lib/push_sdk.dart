...
import 'package:push_sdk/mobpush_local_notification.dart';

typedef EventHandler = void Function(dynamic event);

class PushSdk {
  static const MethodChannel _channel = MethodChannel('push_sdk');
  static const EventChannel _channelReciever = EventChannel('mobpush_receiver');
